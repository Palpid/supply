...
namespace HKSupply.Models
{
    ...
    {
        [Column("ID_HW_TYPE_L3", TypeName = "NVARCHAR"), Key, StringLength(100)]
        public string IdHwTypeL3 { get; set; }
        [Column("ID_HW_TYPE_L2", TypeName = "NVARCHAR"), StringLength(100), Required]
        public string IdHwTypeL2 { get; set; }
        [Column("ID_HW_TYPE_L1", TypeName = "NVARCHAR"), StringLength(100), Required]
