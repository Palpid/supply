...
namespace HKSupply.Models
{
    ...
    {
        [Column("ID_MATERIAL_L3", TypeName = "NVARCHAR"), Key, StringLength(100)]
        public string IdMaterialL3 { get; set; }
        [Column("ID_MATERIAL_L2", TypeName = "NVARCHAR"), StringLength(100), Required]
        public string IdMaterialL2 { get; set; }
        [Column("ID_MATERIAL_L1", TypeName = "NVARCHAR"), StringLength(100), Required]
